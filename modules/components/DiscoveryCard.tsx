  ...
  return (
    <div className="group bg-black text-white p-6 rounded-2xl md:w-[635px] h-[280px] shadow-lg cursor-pointer hover:bg-[#C5FF41] hover:rotate-1 transition-all duration-500 ease-in-out overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-4">
        <span className="md:px-4 md:py-2 p-2 rounded-full text-black font-semibold text-sm bg-green-200 group-hover:bg-black group-hover:text-white transition-colors duration-300">
          {title}
        </span>
        <a
          href={link}
          className="flex items-center md:gap-1 gap-5 md:text-sm text-[10px] text-white group-hover:text-black hover:underline transition-colors duration-300 pb-5"
        >
